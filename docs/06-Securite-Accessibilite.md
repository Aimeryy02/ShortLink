...
| A08 — Software or Data Integrity Failures | Git, historique de commits, CI bloquante, lockfile et déploiements issus de `main`. **Réserve mesurée le 19/08/2026** : la construction du frontend n'est pas identique selon l'environnement — `NODE_ENV` n'étant pas défini hors de Vercel, le build local produit 329 570 o (avec le runtime de développement de React) contre 153 784 o en production. Correctif proposé et chiffré en R3 de `docs/12-Axes-amelioration.md`. | GitHub Actions, `package-lock.json`, `docs/12-Axes-amelioration.md` |
